    ...
    return (
        <Drawer variant="permanent" open={isOpen}>
            <DrawerWrapper className='drawerWrapper'>
                <Aside selectedSection={selectedSection} />
                <DrawerContent className='drawerContent'>
                    {isOpen && <ArrowClose ><ChevronLeft /></ArrowClose>}
                    {isOpen && (selectedSection === 'search' ? (
                        <SearchPanel selectedPlaces={selectedPlaces} />
                    ) : (
                        <FavoritesPanel selectedFavoriteId={selectedFavoriteId} favorites={favorites} />
                    ))}
                </DrawerContent>
            </DrawerWrapper>
        </Drawer>
